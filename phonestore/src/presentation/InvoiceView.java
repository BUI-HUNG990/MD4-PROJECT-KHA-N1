...
public class InvoiceView {
    ...
    public static void displayInvoiceMenu() {
        ...
        do {
            ...
            try {
                ...
                switch (choice) {
                    case 1 -> showAllInvoices();
                    case 2 -> addInvoice();
                    case 3 -> displaySearchInvoiceMenu();
    ...
    public static void displaySearchInvoiceMenu() {
        ...
        do {
            ...
            try {
                choice = Integer.parseInt(sc.nextLine());
                switch (choice) {
                    case 1 -> searchInvoiceByCustomerName();
                    case 2 -> searchInvoiceByDate();
                    case 3 -> System.out.println("Quay lại menu hóa đơn");
                    default -> System.out.println("Lựa chọn không hợp lệ. Vui lòng chọn lại.");
                }
            } catch (NumberFormatException e) {
                System.out.println("Lỗi: Vui lòng nhập một số hợp lệ!");
    ...
    private static void showAllInvoices() {
        ...
        if (invoices.isEmpty()) {
            ...
            System.out.println("\n=============== DANH SÁCH HÓA ĐƠN ===============");
            System.out.printf("%-8s | %-8s | %-20s | %-20s | %-12s\n",
                    "Mã HD", "Mã KH", "Tên KH", "Ngày tạo", "Tổng tiền");
            System.out.println("-----------------------------------------------------------");
    ...
    private static void searchInvoiceByDate() {
        ...
        do {
            ...
            try {
                ...
                java.time.LocalDate inputDate = searchDate.toLocalDate();
                java.time.LocalDate today = java.time.LocalDate.now();

                if (inputDate.isAfter(today)) {
                    System.out.println("Không được nhập quá ngày hiện tại. Vui lòng nhập lại!");
                    searchDate = null;
                }
